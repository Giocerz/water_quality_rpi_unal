...
################################################################################
## Form generated from reading UI file 'MonitoringSelectLandscapeXbKLoO.ui'
##
...
"}")
        ...
        self.initBtn.setGeometry(QRect(-6, 220, 491, 51))
...
"")
        ...
        self.imageLbl.setGeometry(QRect(380, 60, 101, 101))
